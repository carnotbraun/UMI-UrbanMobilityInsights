...
for rsu_id in range(6):
    ...
    roads_file = open(f'/Users/carnotbraun/tese-mestrado/simu/data/lust_test/RSU_{rsu_id}.pickle', 'rb')
    ...
    combined_df.to_csv(f'/Users/carnotbraun/tese-mestrado/simu/data/lust_test/RSU_{rsu_id}.csv', index=False)
